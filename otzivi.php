                    ...
                    <div class="questions__inner">
                        ...
                        <div class="questions__content">
                            <div class="questions__heading heading">
                                <p class="heading__subtitle">Есть отзывы или предложения?</p>
                                <h2 class="heading__title">Оставьте прямо сейчас!</h2>
                            </div>
                            <?php
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                $sql = "INSERT INTO $table (first_name, last_name, email, message) VALUES ('$first_name', '$last_name', '$email', '$message')";
                            ...
                            <form class="questions__form" action="" method="post">
                                <div class="questions__form-row">
                                    <label class="questions__form-label">
                                        Имя
                                        <input type="text" name="first_name" class="questions__form-input"
                                            placeholder="Ваше имя" required>
                                    </label>
                                    <label class="questions__form-label">
                                        Фамилия
                                        <input type="text" name="last_name" class="questions__form-input"
                                ...
                                <div class="questions__form-row">
                                    <label class="questions__form-label">
                                        Почта
                                        <input type="email" name="email" class="questions__form-input"
                                            placeholder="Ваша почта" required>
                                    </label>
                                    <label class="questions__form-label">
                                        Тип сообщения
                                        <select name="feedback_type" class="questions__form-input">
                                ...
                                <label class="questions__text-label">
                                    Сообщение
                                    <textarea name="message" class="questions__form-text" placeholder="Ваше сообщение"
                                        required></textarea>
                                </label>
                                <div class="questions__form-row">
                                    <label class="questions__checkbox-label">
                                        ...
                                        Я согласен получать сообщения от представителя "BarBoriski"
                                    </label>
                                    <button type="submit" class="questions__form-btn button">Отправить
                                        сообщение</button>
                                </div>
                                <div class="questions__form-row" style="margin-top: 20px;">
                                    <a href="index.html" class="questions__form-btn button"
