        ...
        <main>
            <ul class="directions__list">
                <?php foreach ($menu_items as $item): ?>
                    <li class="mix directions__list-item">
                        <a class="directions__list-link" href="#!">
                            ...
                            <div class="directions__link-content">
                                <div class="directions__link-tag"><?php echo htmlspecialchars($item['category']); ?></div>
                                <p class="directions__link-text"><?php echo htmlspecialchars($item['description']); ?></p>
            ...
            <a href="index.html" class="qquestions__form-btn buttonnn"
